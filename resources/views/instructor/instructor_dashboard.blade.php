                ...
                <li class="menu">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                            <li>
                                <a href="apps_chat.html"> Profile </a>
                            </li>
                            <li>
                                <a href="apps_chat.html"> Consultation </a>
                            </li>
                            <li>
                                <a href="apps_chat.html"> Inbox </a>
                            </li>
                            <li>
                                <a href="apps_chat.html"> Billings & Earnings </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                            <li>
                                <a href="component_tabs.html"> Accounting </a>
                            </li>
                        </ul>
                    </li>
